...
function activateVibeBar(context) {
    ...
    const cooking = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Right, 96);
    ...
    const render = (s) => {
        if (!s || s.generated === 0) {
            ...
            cooking.color = MUTED;
            cooking.tooltip = new vscode.MarkdownString('**VibeCheck — Cooking %**\n\nAI code you overrode with your own ' +
    ...
    context.subscriptions.push(vibing, learning, cooking, (0, recorder_1.onSummaryChange)(render));
    render(undefined);
